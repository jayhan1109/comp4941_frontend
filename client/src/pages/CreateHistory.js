...
const CreateHistory = () => {
  ...
  const onUnitChange = (id, price) => {
    axios
      .get("https://comp4945projectsprint.azurewebsites.net/api/Services")
      .then((res) => {
  ...
  const onSubmit = (e) => {
    e.preventDefault();
    console.log({
      price: totalServicePrice + unitPrice,
      startDate,
      endDate,
      unitId: selectedUnit,
    ...
    axios
      .post("https://comp4945projectsprint.azurewebsites.net/api/Histories", {
        totalPrice: totalServicePrice + unitPrice,
        startDate,
        endDate,
        unitId: selectedUnit,
        clientId: selectedClient,
  ...
  useEffect(() => {
    axios
      .get("https://comp4945projectsprint.azurewebsites.net/api/Clients")
      .then((res) => {
        setClients(res.data);
      });
  ...
  return (
    <div>
      <form onSubmit={onSubmit}>
        ...
        <div className="mt-3">Price: {unitPrice + totalServicePrice}</div>
